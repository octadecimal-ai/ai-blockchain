-- Migracja: Wstawienie danych do dictionary_options_events
-- ============================================

INSERT INTO public.dictionary_options_events (phase_code, region_code, label, description, utc_start, utc_end, wraps_midnight, priority, volatility_level, volume_impact, typical_duration_min, trading_pattern, dominant_actors, news_sensitivity, category) VALUES
