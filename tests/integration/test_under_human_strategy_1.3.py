...
# Import: plik under_human_strategy_1.3.py → import przez __init__.py
from src.trading.strategies import UnderhumanStrategyV13
...
LOG_FILE = LOG_DIR / "under_human_strategy_1.3.log"
...
def print_detailed_results(result: BacktestResult, year_ranges: Dict[int, Tuple[datetime, datetime]] = None):
    ...
    print("\n" + "=" * 100)
    print("📊 SZCZEGÓŁOWE WYNIKI BACKTESTU - UNDERHUMAN STRATEGY v1.3 (OPUS AI EDGE)")
    print("=" * 100)
...
def main():
    parser = argparse.ArgumentParser(
        description="Backtesting UnderhumanStrategyV13 (OPUS AI EDGE) na danych z bazy danych PostgreSQL",
...
Przykłady:
  ...
  # Test z limitem dni (szybszy)
    python tests/integration/test_under_human_strategy_1.3.py --limit-days=30

  # Test z parametrami
    python tests/integration/test_under_human_strategy_1.3.py --limit-days=365 \\
    ...
    parser.add_argument(
        ...
        type=float,
        default=15.0,
        help='Rozmiar pozycji w %% kapitału (domyślnie: 15.0) - bazowy, będzie skalowany przez Kelly'
    )
    ...
    # Konfiguracja strategii v1.3 OPUS AI EDGE
    strategy_config = {
        "_backtest_mode": True,
        # Regime Detection
        "adx_period": 14,
        ...
        "rr_volatile": 2.0,
        # Adaptive confidence
        "confidence_trending": 7.0,
        "confidence_ranging": 8.0,
        "confidence_volatile": 9.0,
        # ATR
        "atr_period": 14,
        "atr_sl_multiplier": 1.5,
        # Equity curve
        "equity_lookback": 10,
        "equity_boost_threshold": 0.6,
        "equity_cut_threshold": 0.4,
        "equity_boost_multiplier": 1.25,
        "equity_cut_multiplier": 0.75,
        # Max drawdown
        "max_drawdown_percent": 15.0,
        "cooldown_seconds": 180
    }
    
    strategy = UnderhumanStrategyV13(config=strategy_config)
    ...
    print("\n" + "=" * 100)
    print("🧠 BACKTEST - UNDERHUMAN STRATEGY v1.3 (OPUS AI EDGE)")
    print("=" * 100)
