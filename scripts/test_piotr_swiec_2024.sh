...
# ============================================================================
# Backtest Strategii Piotra Święsa - Dane z 2024 roku
# ============================================================================
# Testuje strategię na danych historycznych BTC/USDT z 2024 roku.
# Dane: 1h timeframe, 8762 świec
#
# Użycie:
#   ./scripts/test_piotr_swiec_2024.sh
#   ./scripts/test_piotr_swiec_2024.sh --param impulse_threshold_pct=1.0
#
# Autor: AI Assistant
# Data: 2025-12-13
# ============================================================================
...
# === Domyślne parametry ===
CSV_FILE="data/backtest_periods/binance/BTCUSDT_2024_1h.csv"
METADATA_FILE="data/backtest_periods/binance/BTCUSDT_2024_1h_metadata.json"
BALANCE=10000
LEVERAGE=3.0
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            echo ""
            echo -e "${MAGENTA}📊 Backtest Strategii Piotra Święsa - 2024${NC}"
            echo ""
            echo "Użycie: $0 [OPCJE]"
            echo ""
...
echo ""
echo -e "${MAGENTA}╔══════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${MAGENTA}║${NC}  ${WHITE}📊 BACKTEST STRATEGII PIOTRA ŚWIĘSA - 2024${NC}                      ${MAGENTA}║${NC}"
echo -e "${MAGENTA}╠══════════════════════════════════════════════════════════════════╣${NC}"
echo -e "${MAGENTA}║${NC}  ${GREEN}Dane:${NC} BTC/USDT 1h (8762 świec)                                ${MAGENTA}║${NC}"
echo -e "${MAGENTA}║${NC}  ${GREEN}Okres:${NC} 2024-01-01 → 2024-12-31                                ${MAGENTA}║${NC}"
