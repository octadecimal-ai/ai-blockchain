#!/usr/bin/env python3
"""
Uruchom migrację: Utworzenie tabeli gdelt_sentiment
"""
...
def main():
    ...
    migration_file = project_root / 'src/database/migrations/06-create-gdelt-sentiment.sql'
    ...
    logger.info("🚀 Wykonuję migrację: Utworzenie tabeli gdelt_sentiment...")
    try:
