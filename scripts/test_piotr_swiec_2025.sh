...
# ============================================================================
# Backtest Strategii Piotra Święsa - Dane z 2025 roku
# ============================================================================
# Testuje strategię na danych historycznych BTC/USDT z 2025 roku.
# Dane: 1h timeframe, 8256 świec (do 2025-12-10)
#
# Użycie:
#   ./scripts/test_piotr_swiec_2025.sh
#   ./scripts/test_piotr_swiec_2025.sh --param impulse_threshold_pct=1.0
#
# Autor: AI Assistant
# Data: 2025-12-13
# ============================================================================
...
METADATA_FILE="data/backtest_periods/binance/BTCUSDT_2025_1h_metadata.json"
BALANCE=10000
LEVERAGE=3.0
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            echo ""
            echo -e "${MAGENTA}📊 Backtest Strategii Piotra Święsa - 2025${NC}"
            echo ""
            echo "Użycie: $0 [OPCJE]"
            echo ""
...
echo ""
echo -e "${MAGENTA}╔══════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${MAGENTA}║${NC}  ${WHITE}📊 BACKTEST STRATEGII PIOTRA ŚWIĘSA - 2025${NC}                      ${MAGENTA}║${NC}"
echo -e "${MAGENTA}╠══════════════════════════════════════════════════════════════════╣${NC}"
echo -e "${MAGENTA}║${NC}  ${GREEN}Dane:${NC} BTC/USDT 1h (8256 świec, do 2025-12-10)                  ${MAGENTA}║${NC}"
echo -e "${MAGENTA}║${NC}  ${GREEN}Okres:${NC} 2025-01-01 → 2025-12-10                                ${MAGENTA}║${NC}"
